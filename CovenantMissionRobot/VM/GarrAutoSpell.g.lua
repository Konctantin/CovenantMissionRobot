...
T.GARR_AUTO_SPELL = {
    ...
    [001] = { SpellID = 001, Cooldown = 2, Duration = 1, Flags = 0, SchoolMask = 0x00, Effects = {
        { ID = 001, SpellID = 001, Effect = 01, TargetType = 24, Flags = 0x01, Period = 0, Points = 350 },
    } },
    ...
    [002] = { SpellID = 002, Cooldown = 4, Duration = 2, Flags = 1, SchoolMask = 0x00, Effects = {
        { ID = 002, SpellID = 002, Effect = 19, TargetType = 22, Flags = 0x01, Period = 2, Points = 0.2 },
        { ID = 120, SpellID = 002, Effect = 04, TargetType = 01, Flags = 0x00, Period = 0, Points = 1 },
    } },

    -- DNT Owen Test Double Effect:
    [003] = { SpellID = 003, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x00, Effects = {
        { ID = 003, SpellID = 003, Effect = 02, TargetType = 01, Flags = 0x00, Period = 0, Points = 45.2 },
        { ID = 004, SpellID = 003, Effect = 01, TargetType = 03, Flags = 0x00, Period = 0, Points = 90.4 },
    } },
    ...
    [004] = { SpellID = 004, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 007, SpellID = 004, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.75 },
        { ID = 008, SpellID = 004, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [005] = { SpellID = 005, Cooldown = 1, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 009, SpellID = 005, Effect = 03, TargetType = 07, Flags = 0x01, Period = 0, Points = 0.1 },
    } },
    ...
    [006] = { SpellID = 006, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 010, SpellID = 006, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 0.6 },
    } },
    ...
    [007] = { SpellID = 007, Cooldown = 2, Duration = 1, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 011, SpellID = 007, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.1 },
    } },
    ...
    [008] = { SpellID = 008, Cooldown = 1, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 012, SpellID = 008, Effect = 01, TargetType = 03, Flags = 0x01, Period = 0, Points = 10 },
    } },
    ...
    [009] = { SpellID = 009, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 013, SpellID = 009, Effect = 04, TargetType = 06, Flags = 0x00, Period = 0, Points = 0.05 },
    } },
    ...
    [010] = { SpellID = 010, Cooldown = 3, Duration = 3, Flags = 0, SchoolMask = 0x10, Effects = {
        { ID = 014, SpellID = 010, Effect = 03, TargetType = 03, Flags = 0x00, Period = 0, Points = 0.2 },
        { ID = 015, SpellID = 010, Effect = 07, TargetType = 07, Flags = 0x00, Period = 0, Points = 0.03 },
        { ID = 016, SpellID = 010, Effect = 08, TargetType = 01, Flags = 0x00, Period = 0, Points = 0.01 },
    } },

    -- Auto Attack: Deal attack damage to the closest enemy.
    [011] = { SpellID = 011, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 017, SpellID = 011, Effect = 01, TargetType = 03, Flags = 0x01, Period = 0, Points = 1 },
    } },

    -- Bone Reconstruction: Heals all allies for $s1.
    [012] = { SpellID = 012, Cooldown = 1, Duration = 1, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 018, SpellID = 012, Effect = 04, TargetType = 06, Flags = 0x01, Period = 0, Points = 0.2 },
    } },

    -- Gentle Caress:
    [013] = { SpellID = 013, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 019, SpellID = 013, Effect = 02, TargetType = 02, Flags = 0x00, Period = 0, Points = 10 },
    } },

    -- Spirit's Caress: Anjali heals all allies for $s1.
    [014] = { SpellID = 014, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 020, SpellID = 014, Effect = 04, TargetType = 06, Flags = 0x01, Period = 0, Points = 0.1 },
    } },

    -- Auto Attack: Deal damage to an enemy at range.
    [015] = { SpellID = 015, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 021, SpellID = 015, Effect = 01, TargetType = 05, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [016] = { SpellID = 016, Cooldown = 1, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 022, SpellID = 016, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 0.75 },
    } },
    ...
    [017] = { SpellID = 017, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x10, Effects = {
        { ID = 023, SpellID = 017, Effect = 03, TargetType = 07, Flags = 0x01, Period = 0, Points = 0.1 },
        { ID = 024, SpellID = 017, Effect = 02, TargetType = 01, Flags = 0x01, Period = 0, Points = 100 },
        { ID = 025, SpellID = 017, Effect = 00, TargetType = 07, Flags = 0x01, Period = 0, Points = 0 },
    } },
    ...
    [018] = { SpellID = 018, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 026, SpellID = 018, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.2 },
        { ID = 027, SpellID = 018, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.2 },
        { ID = 028, SpellID = 018, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.2 },
    } },
    ...
    [019] = { SpellID = 019, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x04, Effects = {
        { ID = 029, SpellID = 019, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 1.5 },
    } },
    ...
    [020] = { SpellID = 020, Cooldown = 1, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 030, SpellID = 020, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 0.7 },
    } },
    ...
    [021] = { SpellID = 021, Cooldown = 4, Duration = 4, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 031, SpellID = 021, Effect = 08, TargetType = 06, Flags = 0x01, Period = 0, Points = 0.25 },
    } },
    ...
    [022] = { SpellID = 022, Cooldown = 3, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 032, SpellID = 022, Effect = 03, TargetType = 09, Flags = 0x01, Period = 0, Points = 0.9 },
        { ID = 033, SpellID = 022, Effect = 07, TargetType = 09, Flags = 0x01, Period = 0, Points = 0.1 },
    } },

    -- DNT JasonTest Taunt Spell: Taunt
    [023] = { SpellID = 023, Cooldown = 0, Duration = 2, Flags = 0, SchoolMask = 0x00, Effects = {
        { ID = 034, SpellID = 023, Effect = 10, TargetType = 01, Flags = 0x00, Period = 0, Points = 11 },
        { ID = 092, SpellID = 023, Effect = 07, TargetType = 11, Flags = 0x00, Period = 0, Points = 0.1 },
    } },
    ...
    [024] = { SpellID = 024, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x02, Effects = {
        { ID = 035, SpellID = 024, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 1.8 },
        { ID = 036, SpellID = 024, Effect = 04, TargetType = 02, Flags = 0x01, Period = 0, Points = 0.2 },
    } },
    ...
    [025] = { SpellID = 025, Cooldown = 2, Duration = 3, Flags = 0, SchoolMask = 0x02, Effects = {
        { ID = 037, SpellID = 025, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.5 },
        { ID = 038, SpellID = 025, Effect = 12, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.2 },
    } },
    ...
    [026] = { SpellID = 026, Cooldown = 3, Duration = 2, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 039, SpellID = 026, Effect = 04, TargetType = 02, Flags = 0x01, Period = 0, Points = 1 },
        { ID = 040, SpellID = 026, Effect = 18, TargetType = 02, Flags = 0x01, Period = 0, Points = 0.2 },
    } },

    -- XX - Test - Physical:
    [027] = { SpellID = 027, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 041, SpellID = 027, Effect = 01, TargetType = 03, Flags = 0x01, Period = 0, Points = 1 },
    } },

    -- XX - Test - Melee - Holy:
    [028] = { SpellID = 028, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x02, Effects = {
        { ID = 042, SpellID = 028, Effect = 01, TargetType = 03, Flags = 0x01, Period = 0, Points = 1 },
    } },

    -- XX - Test - Melee - Fire:
    [029] = { SpellID = 029, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x04, Effects = {
        { ID = 043, SpellID = 029, Effect = 01, TargetType = 03, Flags = 0x01, Period = 0, Points = 1 },
    } },

    -- XX - Test - Melee - Nature:
    [030] = { SpellID = 030, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 044, SpellID = 030, Effect = 01, TargetType = 03, Flags = 0x01, Period = 0, Points = 1 },
    } },

    -- XX - Test - Melee - Frost:
    [031] = { SpellID = 031, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x10, Effects = {
        { ID = 045, SpellID = 031, Effect = 01, TargetType = 03, Flags = 0x01, Period = 0, Points = 1 },
    } },

    -- XX - Test - Melee - Shadow:
    [032] = { SpellID = 032, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 046, SpellID = 032, Effect = 01, TargetType = 03, Flags = 0x01, Period = 0, Points = 1 },
    } },

    -- XX - Test - Melee - Arcane:
    [033] = { SpellID = 033, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 047, SpellID = 033, Effect = 01, TargetType = 03, Flags = 0x01, Period = 0, Points = 1 },
    } },

    -- XX - Test - Ranged - Physical:
    [034] = { SpellID = 034, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 048, SpellID = 034, Effect = 01, TargetType = 07, Flags = 0x01, Period = 0, Points = 1 },
    } },

    -- XX - Test - Ranged - Holy:
    [035] = { SpellID = 035, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x02, Effects = {
        { ID = 049, SpellID = 035, Effect = 01, TargetType = 07, Flags = 0x01, Period = 0, Points = 1 },
    } },

    -- XX - Test - Ranged - Fire:
    [036] = { SpellID = 036, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x04, Effects = {
        { ID = 050, SpellID = 036, Effect = 01, TargetType = 07, Flags = 0x01, Period = 0, Points = 1 },
    } },

    -- XX - Test - Ranged - Nature:
    [037] = { SpellID = 037, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 051, SpellID = 037, Effect = 01, TargetType = 07, Flags = 0x01, Period = 0, Points = 1 },
    } },

    -- XX - Test - Ranged - Frost:
    [038] = { SpellID = 038, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x10, Effects = {
        { ID = 052, SpellID = 038, Effect = 01, TargetType = 07, Flags = 0x01, Period = 0, Points = 1 },
    } },

    -- XX - Test - Ranged - Shadow:
    [039] = { SpellID = 039, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 053, SpellID = 039, Effect = 01, TargetType = 07, Flags = 0x01, Period = 0, Points = 1 },
    } },

    -- XX - Test - Ranged - Arcane:
    [040] = { SpellID = 040, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 054, SpellID = 040, Effect = 01, TargetType = 07, Flags = 0x01, Period = 0, Points = 1 },
    } },
    ...
    [041] = { SpellID = 041, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 055, SpellID = 041, Effect = 07, TargetType = 09, Flags = 0x01, Period = 0, Points = 0.25 },
    } },

    -- JasonTest Passive:
    [042] = { SpellID = 042, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x00, Effects = {
        { ID = 056, SpellID = 042, Effect = 16, TargetType = 01, Flags = 0x00, Period = 0, Points = 0.1 },
    } },
    ...
    [043] = { SpellID = 043, Cooldown = 1, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 057, SpellID = 043, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 0.25 },
        { ID = 058, SpellID = 043, Effect = 04, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.2 },
    } },
    ...
    [044] = { SpellID = 044, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 059, SpellID = 044, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.5 },
        { ID = 060, SpellID = 044, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.25 },
    } },
    ...
    [045] = { SpellID = 045, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 061, SpellID = 045, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 0.75 },
        { ID = 062, SpellID = 045, Effect = 04, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.25 },
    } },
    ...
    [046] = { SpellID = 046, Cooldown = 2, Duration = 1, Flags = 0, SchoolMask = 0x02, Effects = {
        { ID = 063, SpellID = 046, Effect = 14, TargetType = 01, Flags = 0x00, Period = 0, Points = -0.1 },
        { ID = 064, SpellID = 046, Effect = 14, TargetType = 16, Flags = 0x00, Period = 0, Points = -0.1 },
    } },
    ...
    [047] = { SpellID = 047, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 065, SpellID = 047, Effect = 14, TargetType = 06, Flags = 0x00, Period = 0, Points = -0.2 },
    } },
    ...
    [048] = { SpellID = 048, Cooldown = 4, Duration = 1, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 066, SpellID = 048, Effect = 10, TargetType = 01, Flags = 0x01, Period = 0, Points = 0 },
        { ID = 067, SpellID = 048, Effect = 04, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.2 },
    } },
    ...
    [049] = { SpellID = 049, Cooldown = 4, Duration = 4, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 068, SpellID = 049, Effect = 14, TargetType = 17, Flags = 0x00, Period = 0, Points = 0.33 },
    } },
    ...
    [050] = { SpellID = 050, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 069, SpellID = 050, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 1.2 },
    } },
    ...
    [051] = { SpellID = 051, Cooldown = 5, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 070, SpellID = 051, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.75 },
    } },
    ...
    [052] = { SpellID = 052, Cooldown = 5, Duration = 4, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 071, SpellID = 052, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 0.3 },
    } },
    ...
    [053] = { SpellID = 053, Cooldown = 6, Duration = 6, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 072, SpellID = 053, Effect = 07, TargetType = 07, Flags = 0x01, Period = 2, Points = 0.1 },
        { ID = 073, SpellID = 053, Effect = 12, TargetType = 07, Flags = 0x01, Period = 2, Points = -0.2 },
    } },
    ...
    [054] = { SpellID = 054, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 074, SpellID = 054, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.9 },
        { ID = 075, SpellID = 054, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 0.9 },
    } },
    ...
    [055] = { SpellID = 055, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 076, SpellID = 055, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 1.5 },
    } },
    ...
    [056] = { SpellID = 056, Cooldown = 1, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 077, SpellID = 056, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 1.25 },
    } },
    ...
    [057] = { SpellID = 057, Cooldown = 5, Duration = 3, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 078, SpellID = 057, Effect = 07, TargetType = 03, Flags = 0x01, Period = 0, Points = 1 },
    } },
    ...
    [058] = { SpellID = 058, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 079, SpellID = 058, Effect = 03, TargetType = 09, Flags = 0x01, Period = 0, Points = 0.7 },
    } },
    ...
    [059] = { SpellID = 059, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 080, SpellID = 059, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [060] = { SpellID = 060, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 081, SpellID = 060, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 0.4 },
    } },
    ...
    [061] = { SpellID = 061, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 082, SpellID = 061, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.75 },
    } },
    ...
    [062] = { SpellID = 062, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 083, SpellID = 062, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.3 },
    } },
    ...
    [063] = { SpellID = 063, Cooldown = 5, Duration = 2, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 084, SpellID = 063, Effect = 03, TargetType = 07, Flags = 0x01, Period = 0, Points = 0.6 },
        { ID = 085, SpellID = 063, Effect = 12, TargetType = 07, Flags = 0x00, Period = 0, Points = -0.2 },
    } },
    ...
    [064] = { SpellID = 064, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 086, SpellID = 064, Effect = 03, TargetType = 07, Flags = 0x01, Period = 0, Points = 1.5 },
    } },
    ...
    [065] = { SpellID = 065, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 087, SpellID = 065, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.65 },
    } },
    ...
    [066] = { SpellID = 066, Cooldown = 1, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 088, SpellID = 066, Effect = 03, TargetType = 13, Flags = 0x01, Period = 0, Points = 1.5 },
    } },
    ...
    [067] = { SpellID = 067, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 089, SpellID = 067, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 1.2 },
    } },
    ...
    [068] = { SpellID = 068, Cooldown = 3, Duration = 1, Flags = 1, SchoolMask = 0x02, Effects = {
        { ID = 090, SpellID = 068, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.2 },
        { ID = 091, SpellID = 068, Effect = 12, TargetType = 15, Flags = 0x00, Period = 0, Points = -0.8 },
    } },
    ...
    [069] = { SpellID = 069, Cooldown = 3, Duration = 2, Flags = 0, SchoolMask = 0x00, Effects = {
        { ID = 095, SpellID = 069, Effect = 01, TargetType = 01, Flags = 0x01, Period = 2, Points = 50 },
        { ID = 096, SpellID = 069, Effect = 03, TargetType = 01, Flags = 0x01, Period = 2, Points = 0.2 },
        { ID = 097, SpellID = 069, Effect = 01, TargetType = 01, Flags = 0x00, Period = 0, Points = 50 },
        { ID = 098, SpellID = 069, Effect = 03, TargetType = 00, Flags = 0x00, Period = 0, Points = 0.2 },
    } },
    ...
    [071] = { SpellID = 071, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 099, SpellID = 071, Effect = 02, TargetType = 02, Flags = 0x01, Period = 0, Points = 0.3 },
    } },
    ...
    [072] = { SpellID = 072, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x02, Effects = {
        { ID = 100, SpellID = 072, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 2 },
        { ID = 101, SpellID = 072, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 0.4 },
    } },
    ...
    [073] = { SpellID = 073, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x02, Effects = {
        { ID = 102, SpellID = 073, Effect = 03, TargetType = 13, Flags = 0x01, Period = 0, Points = 1 },
    } },
    ...
    [074] = { SpellID = 074, Cooldown = 5, Duration = 3, Flags = 0, SchoolMask = 0x02, Effects = {
        { ID = 103, SpellID = 074, Effect = 14, TargetType = 01, Flags = 0x00, Period = 0, Points = -0.4 },
        { ID = 104, SpellID = 074, Effect = 12, TargetType = 01, Flags = 0x00, Period = 0, Points = -0.4 },
    } },
    ...
    [075] = { SpellID = 075, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 105, SpellID = 075, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 1.5 },
    } },
    ...
    [076] = { SpellID = 076, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x02, Effects = {
        { ID = 106, SpellID = 076, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 2.25 },
    } },
    ...
    [077] = { SpellID = 077, Cooldown = 5, Duration = 3, Flags = 0, SchoolMask = 0x02, Effects = {
        { ID = 107, SpellID = 077, Effect = 19, TargetType = 06, Flags = 0x01, Period = 0, Points = 0.2 },
    } },
    ...
    [078] = { SpellID = 078, Cooldown = 1, Duration = 0, Flags = 0, SchoolMask = 0x02, Effects = {
        { ID = 108, SpellID = 078, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.3 },
    } },
    ...
    [079] = { SpellID = 079, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x02, Effects = {
        { ID = 109, SpellID = 079, Effect = 03, TargetType = 07, Flags = 0x01, Period = 0, Points = 0.2 },
        { ID = 110, SpellID = 079, Effect = 04, TargetType = 06, Flags = 0x01, Period = 0, Points = 0.2 },
    } },
    ...
    [080] = { SpellID = 080, Cooldown = 3, Duration = 2, Flags = 0, SchoolMask = 0x04, Effects = {
        { ID = 111, SpellID = 080, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 1.2 },
        { ID = 112, SpellID = 080, Effect = 07, TargetType = 05, Flags = 0x01, Period = 0, Points = 0.4 },
    } },
    ...
    [081] = { SpellID = 081, Cooldown = 5, Duration = 3, Flags = 0, SchoolMask = 0x02, Effects = {
        { ID = 113, SpellID = 081, Effect = 15, TargetType = 01, Flags = 0x01, Period = 0, Points = 3 },
    } },
    ...
    [082] = { SpellID = 082, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 114, SpellID = 082, Effect = 16, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.25 },
    } },
    ...
    [083] = { SpellID = 083, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 115, SpellID = 083, Effect = 03, TargetType = 09, Flags = 0x01, Period = 0, Points = 1.2 },
    } },
    ...
    [084] = { SpellID = 084, Cooldown = 4, Duration = 2, Flags = 1, SchoolMask = 0x40, Effects = {
        { ID = 116, SpellID = 084, Effect = 12, TargetType = 07, Flags = 0x00, Period = 0, Points = -1 },
    } },
    ...
    [085] = { SpellID = 085, Cooldown = 3, Duration = 2, Flags = 1, SchoolMask = 0x02, Effects = {
        { ID = 117, SpellID = 085, Effect = 14, TargetType = 02, Flags = 0x00, Period = 0, Points = -50 },
    } },
    ...
    [086] = { SpellID = 086, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 118, SpellID = 086, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [087] = { SpellID = 087, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x02, Effects = {
        { ID = 119, SpellID = 087, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 0.6 },
    } },
    ...
    [088] = { SpellID = 088, Cooldown = 3, Duration = 3, Flags = 0, SchoolMask = 0x02, Effects = {
        { ID = 121, SpellID = 088, Effect = 12, TargetType = 01, Flags = 0x00, Period = 0, Points = 0.3 },
        { ID = 123, SpellID = 088, Effect = 03, TargetType = 07, Flags = 0x01, Period = 0, Points = 0.4 },
    } },
    ...
    [089] = { SpellID = 089, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 124, SpellID = 089, Effect = 07, TargetType = 05, Flags = 0x03, Period = 1, Points = 0.4 },
    } },
    ...
    [090] = { SpellID = 090, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 125, SpellID = 090, Effect = 12, TargetType = 08, Flags = 0x00, Period = 0, Points = 0.2 },
    } },
    ...
    [091] = { SpellID = 091, Cooldown = 4, Duration = 3, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 126, SpellID = 091, Effect = 19, TargetType = 05, Flags = 0x01, Period = 0, Points = -0.6 },
    } },
    ...
    [092] = { SpellID = 092, Cooldown = 2, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 127, SpellID = 092, Effect = 07, TargetType = 17, Flags = 0x03, Period = 1, Points = 0.5 },
    } },
    ...
    [093] = { SpellID = 093, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 128, SpellID = 093, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.2 },
        { ID = 129, SpellID = 093, Effect = 04, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.8 },
    } },
    ...
    [094] = { SpellID = 094, Cooldown = 4, Duration = 3, Flags = 0, SchoolMask = 0x10, Effects = {
        { ID = 130, SpellID = 094, Effect = 07, TargetType = 15, Flags = 0x01, Period = 1, Points = 0.3 },
    } },
    ...
    [095] = { SpellID = 095, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 131, SpellID = 095, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 1.5 },
        { ID = 132, SpellID = 095, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 0.4 },
    } },
    ...
    [096] = { SpellID = 096, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 133, SpellID = 096, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 0.6 },
        { ID = 134, SpellID = 096, Effect = 12, TargetType = 05, Flags = 0x00, Period = 0, Points = -0.3 },
    } },
    ...
    [097] = { SpellID = 097, Cooldown = 2, Duration = 1, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 135, SpellID = 097, Effect = 03, TargetType = 11, Flags = 0x01, Period = 0, Points = 0.9 },
    } },
    ...
    [098] = { SpellID = 098, Cooldown = 1, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 136, SpellID = 098, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 1.2 },
    } },
    ...
    [099] = { SpellID = 099, Cooldown = 3, Duration = 1, Flags = 0, SchoolMask = 0x09, Effects = {
        { ID = 137, SpellID = 099, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 1.4 },
    } },
    ...
    [100] = { SpellID = 100, Cooldown = 1, Duration = 0, Flags = 0, SchoolMask = 0x00, Effects = {
        { ID = 138, SpellID = 100, Effect = 04, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.6 },
    } },
    ...
    [101] = { SpellID = 101, Cooldown = 4, Duration = 3, Flags = 0, SchoolMask = 0x10, Effects = {
        { ID = 139, SpellID = 101, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.6 },
        { ID = 140, SpellID = 101, Effect = 14, TargetType = 03, Flags = 0x00, Period = 0, Points = 0.2 },
    } },
    ...
    [102] = { SpellID = 102, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 141, SpellID = 102, Effect = 03, TargetType = 13, Flags = 0x01, Period = 0, Points = 0.3 },
    } },
    ...
    [103] = { SpellID = 103, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 142, SpellID = 103, Effect = 12, TargetType = 22, Flags = 0x00, Period = 0, Points = 1 },
    } },
    ...
    [104] = { SpellID = 104, Cooldown = 1, Duration = 1, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 143, SpellID = 104, Effect = 02, TargetType = 02, Flags = 0x01, Period = 0, Points = 0.9 },
        { ID = 144, SpellID = 104, Effect = 12, TargetType = 02, Flags = 0x00, Period = 0, Points = -0.1 },
    } },

    -- Hold the Line: Korayn and allies take 10% less damage.
    [105] = { SpellID = 105, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 145, SpellID = 105, Effect = 14, TargetType = 06, Flags = 0x00, Period = 0, Points = -0.1 },
    } },
    ...
    [106] = { SpellID = 106, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 146, SpellID = 106, Effect = 03, TargetType = 09, Flags = 0x01, Period = 0, Points = 0.4 },
    } },
    ...
    [107] = { SpellID = 107, Cooldown = 5, Duration = 3, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 147, SpellID = 107, Effect = 07, TargetType = 03, Flags = 0x03, Period = 0, Points = 1.5 },
        { ID = 148, SpellID = 107, Effect = 20, TargetType = 03, Flags = 0x03, Period = 0, Points = 0.5 },
    } },
    ...
    [108] = { SpellID = 108, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 149, SpellID = 108, Effect = 04, TargetType = 02, Flags = 0x01, Period = 0, Points = 0.4 },
        { ID = 150, SpellID = 108, Effect = 18, TargetType = 02, Flags = 0x02, Period = 0, Points = 0.1 },
    } },
    ...
    [109] = { SpellID = 109, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 151, SpellID = 109, Effect = 16, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.6 },
    } },

    -- Ravenous Brooch: Heirmir's brooch heals her for $s1.
    [110] = { SpellID = 110, Cooldown = 1, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 152, SpellID = 110, Effect = 04, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.4 },
    } },
    ...
    [111] = { SpellID = 111, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 153, SpellID = 111, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 1 },
    } },
    ...
    [112] = { SpellID = 112, Cooldown = 5, Duration = 3, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 154, SpellID = 112, Effect = 19, TargetType = 08, Flags = 0x03, Period = 0, Points = 0.3 },
    } },
    ...
    [113] = { SpellID = 113, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x30, Effects = {
        { ID = 155, SpellID = 113, Effect = 03, TargetType = 11, Flags = 0x01, Period = 0, Points = 1.2 },
    } },
    ...
    [114] = { SpellID = 114, Cooldown = 1, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 156, SpellID = 114, Effect = 02, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.6 },
    } },
    ...
    [115] = { SpellID = 115, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 157, SpellID = 115, Effect = 03, TargetType = 09, Flags = 0x01, Period = 0, Points = 0.7 },
    } },
    ...
    [116] = { SpellID = 116, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 158, SpellID = 116, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 1.2 },
    } },
    ...
    [117] = { SpellID = 117, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 159, SpellID = 117, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.4 },
    } },
    ...
    [118] = { SpellID = 118, Cooldown = 4, Duration = 0, Flags = 1, SchoolMask = 0x08, Effects = {
        { ID = 160, SpellID = 118, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 2 },
    } },
    ...
    [119] = { SpellID = 119, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 161, SpellID = 119, Effect = 03, TargetType = 11, Flags = 0x01, Period = 0, Points = 1 },
    } },
    ...
    [120] = { SpellID = 120, Cooldown = 2, Duration = 2, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 162, SpellID = 120, Effect = 12, TargetType = 20, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [121] = { SpellID = 121, Cooldown = 3, Duration = 1, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 163, SpellID = 121, Effect = 12, TargetType = 07, Flags = 0x01, Period = 0, Points = -0.5 },
    } },
    ...
    [122] = { SpellID = 122, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x04, Effects = {
        { ID = 164, SpellID = 122, Effect = 07, TargetType = 21, Flags = 0x01, Period = 3, Points = 0.3 },
    } },
    ...
    [123] = { SpellID = 123, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 165, SpellID = 123, Effect = 04, TargetType = 14, Flags = 0x01, Period = 0, Points = 0.3 },
    } },
    ...
    [124] = { SpellID = 124, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 166, SpellID = 124, Effect = 03, TargetType = 09, Flags = 0x01, Period = 0, Points = 0.6 },
    } },
    ...
    [125] = { SpellID = 125, Cooldown = 3, Duration = 1, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 167, SpellID = 125, Effect = 03, TargetType = 20, Flags = 0x01, Period = 0, Points = 0.6 },
        { ID = 168, SpellID = 125, Effect = 12, TargetType = 20, Flags = 0x00, Period = 1, Points = -0.5 },
    } },
    ...
    [126] = { SpellID = 126, Cooldown = 3, Duration = 1, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 169, SpellID = 126, Effect = 04, TargetType = 14, Flags = 0x01, Period = 0, Points = 0.2 },
    } },
    ...
    [127] = { SpellID = 127, Cooldown = 4, Duration = 1, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 170, SpellID = 127, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.6 },
    } },
    ...
    [128] = { SpellID = 128, Cooldown = 5, Duration = 1, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 171, SpellID = 128, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 0.75 },
    } },
    ...
    [129] = { SpellID = 129, Cooldown = 5, Duration = 1, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 172, SpellID = 129, Effect = 04, TargetType = 06, Flags = 0x01, Period = 0, Points = 0.3 },
        { ID = 173, SpellID = 129, Effect = 12, TargetType = 06, Flags = 0x00, Period = 1, Points = 0.5 },
    } },
    ...
    [130] = { SpellID = 130, Cooldown = 4, Duration = 3, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 174, SpellID = 130, Effect = 16, TargetType = 01, Flags = 0x01, Period = 0, Points = 1 },
    } },
    ...
    [131] = { SpellID = 131, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 175, SpellID = 131, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 1.5 },
    } },
    ...
    [132] = { SpellID = 132, Cooldown = 4, Duration = 1, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 176, SpellID = 132, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.5 },
        { ID = 177, SpellID = 132, Effect = 12, TargetType = 15, Flags = 0x00, Period = 1, Points = -0.25 },
    } },
    ...
    [133] = { SpellID = 133, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 178, SpellID = 133, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 1 },
        { ID = 179, SpellID = 133, Effect = 04, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.75 },
    } },
    ...
    [134] = { SpellID = 134, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 180, SpellID = 134, Effect = 14, TargetType = 07, Flags = 0x01, Period = 0, Points = 0.25 },
    } },
    ...
    [135] = { SpellID = 135, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x04, Effects = {
        { ID = 181, SpellID = 135, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 3 },
    } },
    ...
    [136] = { SpellID = 136, Cooldown = 4, Duration = 3, Flags = 0, SchoolMask = 0x04, Effects = {
        { ID = 182, SpellID = 136, Effect = 07, TargetType = 03, Flags = 0x01, Period = 3, Points = 1.5 },
    } },
    ...
    [137] = { SpellID = 137, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 183, SpellID = 137, Effect = 12, TargetType = 01, Flags = 0x00, Period = 0, Points = 0.25 },
    } },
    ...
    [138] = { SpellID = 138, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 184, SpellID = 138, Effect = 03, TargetType = 09, Flags = 0x01, Period = 0, Points = 0.3 },
    } },
    ...
    [139] = { SpellID = 139, Cooldown = 6, Duration = 0, Flags = 1, SchoolMask = 0x40, Effects = {
        { ID = 185, SpellID = 139, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 4 },
    } },
    ...
    [140] = { SpellID = 140, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 186, SpellID = 140, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 0.6 },
        { ID = 187, SpellID = 140, Effect = 12, TargetType = 17, Flags = 0x00, Period = 0, Points = -0.1 },
    } },
    ...
    [141] = { SpellID = 141, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 188, SpellID = 141, Effect = 14, TargetType = 06, Flags = 0x00, Period = 0, Points = -0.5 },
    } },
    ...
    [142] = { SpellID = 142, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 189, SpellID = 142, Effect = 04, TargetType = 10, Flags = 0x01, Period = 0, Points = 0.7 },
    } },
    ...
    [143] = { SpellID = 143, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 190, SpellID = 143, Effect = 12, TargetType = 01, Flags = 0x00, Period = 2, Points = 0.25 },
    } },
    ...
    [144] = { SpellID = 144, Cooldown = 4, Duration = 2, Flags = 1, SchoolMask = 0x20, Effects = {
        { ID = 191, SpellID = 144, Effect = 14, TargetType = 22, Flags = 0x00, Period = 0, Points = -0.75 },
    } },
    ...
    [145] = { SpellID = 145, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 192, SpellID = 145, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.75 },
    } },
    ...
    [146] = { SpellID = 146, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 193, SpellID = 146, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 0.75 },
    } },
    ...
    [147] = { SpellID = 147, Cooldown = 5, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 194, SpellID = 147, Effect = 14, TargetType = 22, Flags = 0x00, Period = 0, Points = -0.5 },
    } },
    ...
    [148] = { SpellID = 148, Cooldown = 4, Duration = 1, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 195, SpellID = 148, Effect = 04, TargetType = 14, Flags = 0x01, Period = 0, Points = 1.25 },
    } },
    ...
    [149] = { SpellID = 149, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 196, SpellID = 149, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.75 },
    } },
    ...
    [150] = { SpellID = 150, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 197, SpellID = 150, Effect = 03, TargetType = 11, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [151] = { SpellID = 151, Cooldown = 2, Duration = 1, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 198, SpellID = 151, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.2 },
    } },
    ...
    [152] = { SpellID = 152, Cooldown = 5, Duration = 1, Flags = 1, SchoolMask = 0x08, Effects = {
        { ID = 199, SpellID = 152, Effect = 04, TargetType = 22, Flags = 0x01, Period = 0, Points = 2 },
        { ID = 200, SpellID = 152, Effect = 12, TargetType = 22, Flags = 0x00, Period = 1, Points = 0.5 },
    } },
    ...
    [153] = { SpellID = 153, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 201, SpellID = 153, Effect = 03, TargetType = 11, Flags = 0x01, Period = 0, Points = 0.75 },
    } },
    ...
    [154] = { SpellID = 154, Cooldown = 5, Duration = 3, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 202, SpellID = 154, Effect = 16, TargetType = 01, Flags = 0x01, Period = 0, Points = 1 },
    } },
    ...
    [155] = { SpellID = 155, Cooldown = 4, Duration = 1, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 203, SpellID = 155, Effect = 12, TargetType = 07, Flags = 0x00, Period = 0, Points = -0.75 },
    } },
    ...
    [156] = { SpellID = 156, Cooldown = 5, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 204, SpellID = 156, Effect = 14, TargetType = 07, Flags = 0x00, Period = 0, Points = 0.4 },
    } },
    ...
    [157] = { SpellID = 157, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 205, SpellID = 157, Effect = 03, TargetType = 09, Flags = 0x01, Period = 0, Points = 0.8 },
    } },
    ...
    [158] = { SpellID = 158, Cooldown = 3, Duration = 0, Flags = 1, SchoolMask = 0x20, Effects = {
        { ID = 206, SpellID = 158, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 3 },
    } },
    ...
    [159] = { SpellID = 159, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 207, SpellID = 159, Effect = 12, TargetType = 07, Flags = 0x00, Period = 2, Points = -0.25 },
    } },
    ...
    [160] = { SpellID = 160, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 208, SpellID = 160, Effect = 03, TargetType = 07, Flags = 0x01, Period = 0, Points = 2 },
    } },
    ...
    [161] = { SpellID = 161, Cooldown = 4, Duration = 1, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 209, SpellID = 161, Effect = 04, TargetType = 06, Flags = 0x01, Period = 0, Points = 1 },
        { ID = 210, SpellID = 161, Effect = 12, TargetType = 06, Flags = 0x00, Period = 0, Points = 0.25 },
    } },
    ...
    [162] = { SpellID = 162, Cooldown = 5, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 211, SpellID = 162, Effect = 12, TargetType = 07, Flags = 0x00, Period = 0, Points = -0.5 },
    } },
    ...
    [163] = { SpellID = 163, Cooldown = 6, Duration = 0, Flags = 1, SchoolMask = 0x20, Effects = {
        { ID = 212, SpellID = 163, Effect = 03, TargetType = 07, Flags = 0x01, Period = 0, Points = 4 },
    } },
    ...
    [164] = { SpellID = 164, Cooldown = 6, Duration = 3, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 213, SpellID = 164, Effect = 07, TargetType = 11, Flags = 0x03, Period = 3, Points = 2 },
    } },
    ...
    [165] = { SpellID = 165, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 214, SpellID = 165, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 3 },
    } },
    ...
    [166] = { SpellID = 166, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 215, SpellID = 166, Effect = 03, TargetType = 21, Flags = 0x01, Period = 0, Points = 1 },
        { ID = 216, SpellID = 166, Effect = 04, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [167] = { SpellID = 167, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 217, SpellID = 167, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 1.5 },
    } },
    ...
    [168] = { SpellID = 168, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 218, SpellID = 168, Effect = 12, TargetType = 03, Flags = 0x00, Period = 0, Points = -0.5 },
    } },
    ...
    [169] = { SpellID = 169, Cooldown = 5, Duration = 3, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 219, SpellID = 169, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.65 },
        { ID = 220, SpellID = 169, Effect = 07, TargetType = 03, Flags = 0x03, Period = 3, Points = 0.5 },
    } },
    ...
    [170] = { SpellID = 170, Cooldown = 4, Duration = 1, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 221, SpellID = 170, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.6 },
    } },
    ...
    [171] = { SpellID = 171, Cooldown = 3, Duration = 1, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 222, SpellID = 171, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 1 },
    } },
    ...
    [172] = { SpellID = 172, Cooldown = 3, Duration = 1, Flags = 1, SchoolMask = 0x20, Effects = {
        { ID = 223, SpellID = 172, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.2 },
        { ID = 224, SpellID = 172, Effect = 12, TargetType = 15, Flags = 0x00, Period = 0, Points = -0.5 },
    } },
    ...
    [173] = { SpellID = 173, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x10, Effects = {
        { ID = 225, SpellID = 173, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 0.75 },
        { ID = 226, SpellID = 173, Effect = 12, TargetType = 05, Flags = 0x00, Period = 0, Points = -0.25 },
    } },
    ...
    [174] = { SpellID = 174, Cooldown = 4, Duration = 3, Flags = 0, SchoolMask = 0x10, Effects = {
        { ID = 227, SpellID = 174, Effect = 16, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.4 },
    } },
    ...
    [175] = { SpellID = 175, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 228, SpellID = 175, Effect = 03, TargetType = 19, Flags = 0x01, Period = 0, Points = 1.2 },
    } },
    ...
    [176] = { SpellID = 176, Cooldown = 3, Duration = 1, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 229, SpellID = 176, Effect = 14, TargetType = 07, Flags = 0x00, Period = 0, Points = 0.25 },
    } },
    ...
    [177] = { SpellID = 177, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 230, SpellID = 177, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [178] = { SpellID = 178, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 231, SpellID = 178, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 1 },
        { ID = 232, SpellID = 178, Effect = 04, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [179] = { SpellID = 179, Cooldown = 6, Duration = 2, Flags = 0, SchoolMask = 0x02, Effects = {
        { ID = 233, SpellID = 179, Effect = 04, TargetType = 06, Flags = 0x01, Period = 0, Points = 1 },
        { ID = 234, SpellID = 179, Effect = 12, TargetType = 06, Flags = 0x00, Period = 0, Points = 0.5 },
    } },
    ...
    [180] = { SpellID = 180, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 235, SpellID = 180, Effect = 03, TargetType = 20, Flags = 0x01, Period = 0, Points = 0.75 },
    } },
    ...
    [181] = { SpellID = 181, Cooldown = 6, Duration = 0, Flags = 1, SchoolMask = 0x20, Effects = {
        { ID = 236, SpellID = 181, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 1.5 },
    } },
    ...
    [182] = { SpellID = 182, Cooldown = 5, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 237, SpellID = 182, Effect = 12, TargetType = 07, Flags = 0x00, Period = 0, Points = -0.5 },
    } },
    ...
    [183] = { SpellID = 183, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 238, SpellID = 183, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [184] = { SpellID = 184, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 239, SpellID = 184, Effect = 03, TargetType = 11, Flags = 0x01, Period = 0, Points = 0.75 },
    } },
    ...
    [185] = { SpellID = 185, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 240, SpellID = 185, Effect = 03, TargetType = 07, Flags = 0x01, Period = 0, Points = 1 },
    } },
    ...
    [186] = { SpellID = 186, Cooldown = 5, Duration = 0, Flags = 1, SchoolMask = 0x20, Effects = {
        { ID = 241, SpellID = 186, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 2 },
    } },
    ...
    [187] = { SpellID = 187, Cooldown = 5, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 242, SpellID = 187, Effect = 07, TargetType = 07, Flags = 0x03, Period = 2, Points = 0.5 },
    } },
    ...
    [188] = { SpellID = 188, Cooldown = 3, Duration = 1, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 243, SpellID = 188, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.5 },
        { ID = 244, SpellID = 188, Effect = 12, TargetType = 03, Flags = 0x00, Period = 0, Points = -0.5 },
    } },
    ...
    [189] = { SpellID = 189, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 245, SpellID = 189, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 2 },
    } },
    ...
    [190] = { SpellID = 190, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 246, SpellID = 190, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 1.5 },
    } },
    ...
    [191] = { SpellID = 191, Cooldown = 1, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 247, SpellID = 191, Effect = 01, TargetType = 07, Flags = 0x01, Period = 0, Points = 0.2 },
        { ID = 248, SpellID = 191, Effect = 02, TargetType = 06, Flags = 0x01, Period = 0, Points = 0.1 },
    } },
    ...
    [192] = { SpellID = 192, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 249, SpellID = 192, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 1.6 },
    } },
    ...
    [193] = { SpellID = 193, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 250, SpellID = 193, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 3 },
        { ID = 251, SpellID = 193, Effect = 03, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [194] = { SpellID = 194, Cooldown = 3, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 252, SpellID = 194, Effect = 19, TargetType = 02, Flags = 0x01, Period = 0, Points = 0.4 },
        { ID = 253, SpellID = 194, Effect = 14, TargetType = 02, Flags = 0x01, Period = 0, Points = -0.2 },
        { ID = 254, SpellID = 194, Effect = 03, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.2 },
    } },
    ...
    [195] = { SpellID = 195, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x10, Effects = {
        { ID = 255, SpellID = 195, Effect = 07, TargetType = 11, Flags = 0x03, Period = 1, Points = 0.8 },
    } },
    ...
    [196] = { SpellID = 196, Cooldown = 5, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 256, SpellID = 196, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 1.2 },
        { ID = 257, SpellID = 196, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.9 },
        { ID = 258, SpellID = 196, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.6 },
        { ID = 259, SpellID = 196, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.3 },
    } },
    ...
    [197] = { SpellID = 197, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 260, SpellID = 197, Effect = 04, TargetType = 08, Flags = 0x01, Period = 0, Points = 0.55 },
    } },
    ...
    [198] = { SpellID = 198, Cooldown = 3, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 261, SpellID = 198, Effect = 20, TargetType = 01, Flags = 0x03, Period = 0, Points = -0.6 },
        { ID = 262, SpellID = 198, Effect = 16, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.6 },
    } },
    ...
    [199] = { SpellID = 199, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 263, SpellID = 199, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 1 },
    } },
    ...
    [200] = { SpellID = 200, Cooldown = 4, Duration = 1, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 264, SpellID = 200, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 1 },
        { ID = 265, SpellID = 200, Effect = 12, TargetType = 15, Flags = 0x00, Period = 1, Points = -0.5 },
    } },
    ...
    [201] = { SpellID = 201, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 266, SpellID = 201, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 2 },
    } },
    ...
    [202] = { SpellID = 202, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 267, SpellID = 202, Effect = 09, TargetType = 07, Flags = 0x01, Period = 0, Points = 2 },
    } },
    ...
    [203] = { SpellID = 203, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 268, SpellID = 203, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 1 },
    } },
    ...
    [204] = { SpellID = 204, Cooldown = 5, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 269, SpellID = 204, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 1.5 },
        { ID = 270, SpellID = 204, Effect = 12, TargetType = 03, Flags = 0x00, Period = 2, Points = -0.5 },
    } },
    ...
    [205] = { SpellID = 205, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 271, SpellID = 205, Effect = 04, TargetType = 14, Flags = 0x01, Period = 0, Points = 0.75 },
    } },
    ...
    [206] = { SpellID = 206, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 272, SpellID = 206, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 1.5 },
    } },
    ...
    [207] = { SpellID = 207, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 273, SpellID = 207, Effect = 03, TargetType = 13, Flags = 0x01, Period = 0, Points = 0.3 },
    } },
    ...
    [208] = { SpellID = 208, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 274, SpellID = 208, Effect = 09, TargetType = 21, Flags = 0x01, Period = 0, Points = 2 },
    } },
    ...
    [209] = { SpellID = 209, Cooldown = 2, Duration = 1, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 275, SpellID = 209, Effect = 12, TargetType = 21, Flags = 0x00, Period = 0, Points = 0.5 },
    } },
    ...
    [210] = { SpellID = 210, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 276, SpellID = 210, Effect = 03, TargetType = 07, Flags = 0x01, Period = 0, Points = 2 },
    } },
    ...
    [211] = { SpellID = 211, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 277, SpellID = 211, Effect = 03, TargetType = 11, Flags = 0x01, Period = 0, Points = 1.5 },
    } },
    ...
    [212] = { SpellID = 212, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 278, SpellID = 212, Effect = 03, TargetType = 19, Flags = 0x01, Period = 0, Points = 2 },
    } },
    ...
    [213] = { SpellID = 213, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 279, SpellID = 213, Effect = 04, TargetType = 10, Flags = 0x01, Period = 0, Points = 1 },
    } },
    ...
    [214] = { SpellID = 214, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 280, SpellID = 214, Effect = 03, TargetType = 11, Flags = 0x01, Period = 0, Points = 1 },
    } },
    ...
    [215] = { SpellID = 215, Cooldown = 5, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 281, SpellID = 215, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 3 },
    } },
    ...
    [216] = { SpellID = 216, Cooldown = 5, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 282, SpellID = 216, Effect = 10, TargetType = 01, Flags = 0x01, Period = 0, Points = 3 },
    } },
    ...
    [217] = { SpellID = 217, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 283, SpellID = 217, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 2 },
    } },
    ...
    [218] = { SpellID = 218, Cooldown = 5, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 284, SpellID = 218, Effect = 14, TargetType = 01, Flags = 0x00, Period = 0, Points = -0.5 },
    } },
    ...
    [219] = { SpellID = 219, Cooldown = 6, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 285, SpellID = 219, Effect = 04, TargetType = 02, Flags = 0x01, Period = 0, Points = 2 },
        { ID = 286, SpellID = 219, Effect = 14, TargetType = 02, Flags = 0x00, Period = 0, Points = -0.5 },
    } },
    ...
    [220] = { SpellID = 220, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 287, SpellID = 220, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 1 },
    } },
    ...
    [221] = { SpellID = 221, Cooldown = 5, Duration = 2, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 288, SpellID = 221, Effect = 10, TargetType = 01, Flags = 0x01, Period = 0, Points = 1.5 },
    } },
    ...
    [222] = { SpellID = 222, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 289, SpellID = 222, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.3 },
        { ID = 290, SpellID = 222, Effect = 07, TargetType = 03, Flags = 0x03, Period = 2, Points = 0.3 },
    } },
    ...
    [223] = { SpellID = 223, Cooldown = 1, Duration = 10, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 291, SpellID = 223, Effect = 07, TargetType = 23, Flags = 0x01, Period = 1, Points = 0.1 },
    } },
    ...
    [224] = { SpellID = 224, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 292, SpellID = 224, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [225] = { SpellID = 225, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 293, SpellID = 225, Effect = 03, TargetType = 11, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [226] = { SpellID = 226, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 294, SpellID = 226, Effect = 03, TargetType = 11, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [227] = { SpellID = 227, Cooldown = 1, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 295, SpellID = 227, Effect = 03, TargetType = 20, Flags = 0x00, Period = 0, Points = 0.3 },
    } },
    ...
    [228] = { SpellID = 228, Cooldown = 10, Duration = 0, Flags = 1, SchoolMask = 0x20, Effects = {
        { ID = 296, SpellID = 228, Effect = 03, TargetType = 23, Flags = 0x01, Period = 0, Points = 10 },
    } },
    ...
    [229] = { SpellID = 229, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 297, SpellID = 229, Effect = 14, TargetType = 21, Flags = 0x00, Period = 0, Points = -0.5 },
    } },
    ...
    [230] = { SpellID = 230, Cooldown = 3, Duration = 1, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 298, SpellID = 230, Effect = 04, TargetType = 24, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [231] = { SpellID = 231, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 299, SpellID = 231, Effect = 14, TargetType = 20, Flags = 0x00, Period = 0, Points = 1 },
    } },
    ...
    [232] = { SpellID = 232, Cooldown = 4, Duration = 3, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 300, SpellID = 232, Effect = 12, TargetType = 20, Flags = 0x00, Period = 3, Points = -0.5 },
    } },
    ...
    [233] = { SpellID = 233, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 301, SpellID = 233, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 1.5 },
    } },
    ...
    [234] = { SpellID = 234, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 302, SpellID = 234, Effect = 12, TargetType = 21, Flags = 0x00, Period = 0, Points = 0.5 },
    } },
    ...
    [235] = { SpellID = 235, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 303, SpellID = 235, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [236] = { SpellID = 236, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 304, SpellID = 236, Effect = 14, TargetType = 06, Flags = 0x00, Period = 2, Points = -0.5 },
    } },
    ...
    [237] = { SpellID = 237, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 305, SpellID = 237, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [238] = { SpellID = 238, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 306, SpellID = 238, Effect = 09, TargetType = 07, Flags = 0x01, Period = 0, Points = 2 },
    } },
    ...
    [239] = { SpellID = 239, Cooldown = 5, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 307, SpellID = 239, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [240] = { SpellID = 240, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 308, SpellID = 240, Effect = 03, TargetType = 13, Flags = 0x01, Period = 0, Points = 0.25 },
    } },
    ...
    [241] = { SpellID = 241, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 309, SpellID = 241, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 0.75 },
        { ID = 310, SpellID = 241, Effect = 12, TargetType = 05, Flags = 0x00, Period = 0, Points = -0.5 },
    } },
    ...
    [242] = { SpellID = 242, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 311, SpellID = 242, Effect = 04, TargetType = 02, Flags = 0x01, Period = 0, Points = 0.5 },
        { ID = 312, SpellID = 242, Effect = 14, TargetType = 02, Flags = 0x00, Period = 0, Points = 0.75 },
    } },
    ...
    [243] = { SpellID = 243, Cooldown = 5, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 313, SpellID = 243, Effect = 09, TargetType = 07, Flags = 0x01, Period = 0, Points = 0 },
        { ID = 314, SpellID = 243, Effect = 14, TargetType = 01, Flags = 0x00, Period = 0, Points = -0.5 },
    } },
    ...
    [244] = { SpellID = 244, Cooldown = 2, Duration = 2, Flags = 1, SchoolMask = 0x01, Effects = {
        { ID = 315, SpellID = 244, Effect = 19, TargetType = 01, Flags = 0x01, Period = 0, Points = 2 },
        { ID = 316, SpellID = 244, Effect = 20, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.3 },
        { ID = 317, SpellID = 244, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.3 },
    } },
    ...
    [245] = { SpellID = 245, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x02, Effects = {
        { ID = 318, SpellID = 245, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 1.2 },
    } },
    ...
    [246] = { SpellID = 246, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 319, SpellID = 246, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 1.5 },
    } },
    ...
    [247] = { SpellID = 247, Cooldown = 4, Duration = 1, Flags = 1, SchoolMask = 0x02, Effects = {
        { ID = 320, SpellID = 247, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.1 },
        { ID = 321, SpellID = 247, Effect = 04, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.2 },
    } },
    ...
    [248] = { SpellID = 248, Cooldown = 5, Duration = 4, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 322, SpellID = 248, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.3 },
        { ID = 323, SpellID = 248, Effect = 07, TargetType = 03, Flags = 0x01, Period = 1, Points = 0.15 },
    } },
    ...
    [249] = { SpellID = 249, Cooldown = 3, Duration = 1, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 324, SpellID = 249, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.6 },
        { ID = 325, SpellID = 249, Effect = 12, TargetType = 03, Flags = 0x00, Period = 0, Points = -0.5 },
    } },
    ...
    [250] = { SpellID = 250, Cooldown = 4, Duration = 0, Flags = 1, SchoolMask = 0x08, Effects = {
        { ID = 326, SpellID = 250, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 0.8 },
    } },
    ...
    [251] = { SpellID = 251, Cooldown = 5, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 327, SpellID = 251, Effect = 12, TargetType = 07, Flags = 0x00, Period = 0, Points = -0.2 },
    } },
    ...
    [252] = { SpellID = 252, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 328, SpellID = 252, Effect = 03, TargetType = 09, Flags = 0x01, Period = 0, Points = 0.6 },
        { ID = 329, SpellID = 252, Effect = 14, TargetType = 09, Flags = 0x00, Period = 0, Points = 0.25 },
    } },
    ...
    [253] = { SpellID = 253, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 330, SpellID = 253, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.75 },
    } },
    ...
    [254] = { SpellID = 254, Cooldown = 3, Duration = 3, Flags = 1, SchoolMask = 0x08, Effects = {
        { ID = 331, SpellID = 254, Effect = 16, TargetType = 22, Flags = 0x01, Period = 0, Points = 1 },
    } },
    ...
    [255] = { SpellID = 255, Cooldown = 3, Duration = 1, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 332, SpellID = 255, Effect = 14, TargetType = 02, Flags = 0x00, Period = 0, Points = -0.5 },
    } },
    ...
    [256] = { SpellID = 256, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 333, SpellID = 256, Effect = 03, TargetType = 11, Flags = 0x01, Period = 0, Points = 1 },
    } },
    ...
    [257] = { SpellID = 257, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 334, SpellID = 257, Effect = 10, TargetType = 01, Flags = 0x01, Period = 0, Points = 1 },
    } },
    ...
    [258] = { SpellID = 258, Cooldown = 5, Duration = 3, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 335, SpellID = 258, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 1 },
        { ID = 336, SpellID = 258, Effect = 07, TargetType = 03, Flags = 0x03, Period = 3, Points = 0.5 },
    } },
    ...
    [259] = { SpellID = 259, Cooldown = 2, Duration = 3, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 337, SpellID = 259, Effect = 07, TargetType = 03, Flags = 0x01, Period = 3, Points = 0.3 },
    } },
    ...
    [260] = { SpellID = 260, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 338, SpellID = 260, Effect = 03, TargetType = 05, Flags = 0x01, Period = 3, Points = 1.5 },
    } },
    ...
    [261] = { SpellID = 261, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 339, SpellID = 261, Effect = 12, TargetType = 02, Flags = 0x00, Period = 0, Points = 0.5 },
    } },
    ...
    [262] = { SpellID = 262, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 340, SpellID = 262, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 1 },
    } },
    ...
    [263] = { SpellID = 263, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 341, SpellID = 263, Effect = 03, TargetType = 11, Flags = 0x01, Period = 0, Points = 1 },
    } },
    ...
    [264] = { SpellID = 264, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 342, SpellID = 264, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 3 },
    } },
    ...
    [265] = { SpellID = 265, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 343, SpellID = 265, Effect = 03, TargetType = 13, Flags = 0x01, Period = 0, Points = 1 },
    } },
    ...
    [266] = { SpellID = 266, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 344, SpellID = 266, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 10 },
    } },
    ...
    [267] = { SpellID = 267, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 345, SpellID = 267, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 1.5 },
    } },
    ...
    [268] = { SpellID = 268, Cooldown = 4, Duration = 3, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 346, SpellID = 268, Effect = 12, TargetType = 15, Flags = 0x00, Period = 0, Points = -0.3 },
    } },
    ...
    [269] = { SpellID = 269, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 347, SpellID = 269, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 1.2 },
    } },
    ...
    [270] = { SpellID = 270, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 348, SpellID = 270, Effect = 12, TargetType = 03, Flags = 0x00, Period = 0, Points = -0.5 },
    } },
    ...
    [271] = { SpellID = 271, Cooldown = 4, Duration = 3, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 349, SpellID = 271, Effect = 07, TargetType = 05, Flags = 0x01, Period = 0, Points = 1 },
    } },
    ...
    [272] = { SpellID = 272, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 350, SpellID = 272, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 1.5 },
    } },
    ...
    [273] = { SpellID = 273, Cooldown = 2, Duration = 1, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 351, SpellID = 273, Effect = 12, TargetType = 03, Flags = 0x00, Period = 0, Points = -0.5 },
    } },
    ...
    [274] = { SpellID = 274, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 352, SpellID = 274, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 1.2 },
    } },
    ...
    [275] = { SpellID = 275, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 353, SpellID = 275, Effect = 12, TargetType = 02, Flags = 0x00, Period = 0, Points = 0.75 },
    } },
    ...
    [276] = { SpellID = 276, Cooldown = 3, Duration = 3, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 354, SpellID = 276, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 0.25 },
        { ID = 355, SpellID = 276, Effect = 07, TargetType = 05, Flags = 0x03, Period = 3, Points = 0.5 },
    } },
    ...
    [277] = { SpellID = 277, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 356, SpellID = 277, Effect = 12, TargetType = 01, Flags = 0x00, Period = 0, Points = 1 },
    } },
    ...
    [278] = { SpellID = 278, Cooldown = 3, Duration = 2, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 357, SpellID = 278, Effect = 14, TargetType = 05, Flags = 0x00, Period = 0, Points = 0.5 },
    } },
    ...
    [279] = { SpellID = 279, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 358, SpellID = 279, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [280] = { SpellID = 280, Cooldown = 6, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 359, SpellID = 280, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 2.5 },
    } },
    ...
    [281] = { SpellID = 281, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 360, SpellID = 281, Effect = 03, TargetType = 05, Flags = 0x01, Period = 3, Points = 1.5 },
    } },
    ...
    [282] = { SpellID = 282, Cooldown = 5, Duration = 0, Flags = 1, SchoolMask = 0x01, Effects = {
        { ID = 361, SpellID = 282, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 10 },
    } },
    ...
    [283] = { SpellID = 283, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 362, SpellID = 283, Effect = 03, TargetType = 13, Flags = 0x01, Period = 0, Points = 0.75 },
    } },
    ...
    [284] = { SpellID = 284, Cooldown = 4, Duration = 1, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 363, SpellID = 284, Effect = 14, TargetType = 22, Flags = 0x00, Period = 0, Points = -0.5 },
    } },
    ...
    [285] = { SpellID = 285, Cooldown = 4, Duration = 2, Flags = 1, SchoolMask = 0x20, Effects = {
        { ID = 364, SpellID = 285, Effect = 14, TargetType = 07, Flags = 0x00, Period = 0, Points = 0.5 },
    } },
    ...
    [286] = { SpellID = 286, Cooldown = 3, Duration = 2, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 365, SpellID = 286, Effect = 12, TargetType = 02, Flags = 0x00, Period = 0, Points = 0.5 },
    } },
    ...
    [287] = { SpellID = 287, Cooldown = 3, Duration = 1, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 366, SpellID = 287, Effect = 14, TargetType = 01, Flags = 0x00, Period = 0, Points = -0.5 },
    } },
    ...
    [288] = { SpellID = 288, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 367, SpellID = 288, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 0.6 },
    } },
    ...
    [289] = { SpellID = 289, Cooldown = 2, Duration = 3, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 368, SpellID = 289, Effect = 07, TargetType = 05, Flags = 0x03, Period = 3, Points = 1 },
    } },
    ...
    [290] = { SpellID = 290, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 369, SpellID = 290, Effect = 03, TargetType = 05, Flags = 0x01, Period = 3, Points = 1.5 },
    } },
    ...
    [291] = { SpellID = 291, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 370, SpellID = 291, Effect = 03, TargetType = 15, Flags = 0x01, Period = 3, Points = 1 },
    } },
    ...
    [292] = { SpellID = 292, Cooldown = 2, Duration = 2, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 371, SpellID = 292, Effect = 14, TargetType = 03, Flags = 0x00, Period = 0, Points = 0.5 },
        { ID = 372, SpellID = 292, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.75 },
    } },
    ...
    [293] = { SpellID = 293, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 373, SpellID = 293, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.6 },
    } },
    ...
    [294] = { SpellID = 294, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 374, SpellID = 294, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 2 },
    } },
    ...
    [295] = { SpellID = 295, Cooldown = 2, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 375, SpellID = 295, Effect = 14, TargetType = 03, Flags = 0x00, Period = 2, Points = 0.5 },
    } },
    ...
    [296] = { SpellID = 296, Cooldown = 3, Duration = 0, Flags = 1, SchoolMask = 0x20, Effects = {
        { ID = 376, SpellID = 296, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 1 },
    } },
    ...
    [297] = { SpellID = 297, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 377, SpellID = 297, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 1 },
        { ID = 378, SpellID = 297, Effect = 04, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.3 },
    } },
    ...
    [298] = { SpellID = 298, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 379, SpellID = 298, Effect = 03, TargetType = 21, Flags = 0x01, Period = 0, Points = 1 },
        { ID = 380, SpellID = 298, Effect = 04, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.3 },
    } },
    ...
    [299] = { SpellID = 299, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 381, SpellID = 299, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 2 },
    } },

    -- Wave of Eternal Death: Powerful death magic rolls across the Planes of Torment, causing a stacking damage over time effect to all of your party.
    [300] = { SpellID = 300, Cooldown = 1, Duration = 3, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 383, SpellID = 300, Effect = 07, TargetType = 23, Flags = 0x01, Period = 1, Points = 0.05 },
    } },

    -- Bombardment of Dread: The Jailer sends a bombardment of missles across Calcis, dealing $s1% of their Health as Shadow damage to a random enemy every turn.
    [301] = { SpellID = 301, Cooldown = 1, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 384, SpellID = 301, Effect = 03, TargetType = 20, Flags = 0x00, Period = 0, Points = 0.1 },
    } },
    ...
    [302] = { SpellID = 302, Cooldown = 1, Duration = 1, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 385, SpellID = 302, Effect = 03, TargetType = 07, Flags = 0x01, Period = 2, Points = 0.2 },
        { ID = 386, SpellID = 302, Effect = 12, TargetType = 07, Flags = 0x01, Period = 0, Points = -0.2 },
    } },
    ...
    [303] = { SpellID = 303, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 387, SpellID = 303, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 0.25 },
    } },
    ...
    [305] = { SpellID = 305, Cooldown = 1, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 411, SpellID = 305, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 1.2 },
    } },
    ...
    [306] = { SpellID = 306, Cooldown = 3, Duration = 3, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 412, SpellID = 306, Effect = 19, TargetType = 02, Flags = 0x01, Period = 0, Points = 0.4 },
        { ID = 413, SpellID = 306, Effect = 18, TargetType = 02, Flags = 0x01, Period = 0, Points = 0.6 },
    } },
    ...
    [307] = { SpellID = 307, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 414, SpellID = 307, Effect = 03, TargetType = 11, Flags = 0x01, Period = 0, Points = 1.6 },
    } },
    ...
    [308] = { SpellID = 308, Cooldown = 3, Duration = 0, Flags = 1, SchoolMask = 0x08, Effects = {
        { ID = 415, SpellID = 308, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 3.5 },
    } },
    ...
    [309] = { SpellID = 309, Cooldown = 4, Duration = 1, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 416, SpellID = 309, Effect = 04, TargetType = 06, Flags = 0x01, Period = 0, Points = 2 },
        { ID = 417, SpellID = 309, Effect = 12, TargetType = 06, Flags = 0x00, Period = 0, Points = 0.3 },
    } },
    ...
    [310] = { SpellID = 310, Cooldown = 2, Duration = 2, Flags = 0, SchoolMask = 0x02, Effects = {
        { ID = 418, SpellID = 310, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 1.4 },
        { ID = 419, SpellID = 310, Effect = 12, TargetType = 01, Flags = 0x00, Period = 0, Points = 0.2 },
    } },
    ...
    [311] = { SpellID = 311, Cooldown = 2, Duration = 2, Flags = 0, SchoolMask = 0x02, Effects = {
        { ID = 420, SpellID = 311, Effect = 04, TargetType = 02, Flags = 0x01, Period = 0, Points = 1.2 },
        { ID = 421, SpellID = 311, Effect = 18, TargetType = 02, Flags = 0x01, Period = 0, Points = 0.4 },
    } },
    ...
    [312] = { SpellID = 312, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x02, Effects = {
        { ID = 422, SpellID = 312, Effect = 03, TargetType = 11, Flags = 0x01, Period = 0, Points = 1.8 },
    } },
    ...
    [313] = { SpellID = 313, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x02, Effects = {
        { ID = 423, SpellID = 313, Effect = 04, TargetType = 06, Flags = 0x01, Period = 0, Points = 0.7 },
    } },
    ...
    [314] = { SpellID = 314, Cooldown = 3, Duration = 2, Flags = 0, SchoolMask = 0x02, Effects = {
        { ID = 424, SpellID = 314, Effect = 04, TargetType = 02, Flags = 0x01, Period = 0, Points = 1.3 },
        { ID = 425, SpellID = 314, Effect = 19, TargetType = 02, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [315] = { SpellID = 315, Cooldown = 3, Duration = 2, Flags = 0, SchoolMask = 0x04, Effects = {
        { ID = 426, SpellID = 315, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 1.5 },
        { ID = 427, SpellID = 315, Effect = 12, TargetType = 05, Flags = 0x01, Period = 0, Points = -0.3 },
    } },
    ...
    [316] = { SpellID = 316, Cooldown = 1, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 428, SpellID = 316, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 1 },
        { ID = 429, SpellID = 316, Effect = 04, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.3 },
    } },
    ...
    [317] = { SpellID = 317, Cooldown = 3, Duration = 1, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 430, SpellID = 317, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 1.5 },
        { ID = 431, SpellID = 317, Effect = 20, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.3 },
    } },
    ...
    [318] = { SpellID = 318, Cooldown = 3, Duration = 3, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 432, SpellID = 318, Effect = 19, TargetType = 06, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [319] = { SpellID = 319, Cooldown = 4, Duration = 3, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 433, SpellID = 319, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.8 },
        { ID = 434, SpellID = 319, Effect = 07, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [320] = { SpellID = 320, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x10, Effects = {
        { ID = 435, SpellID = 320, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 1 },
    } },

    -- Adjustment: Heals the closest ally for $s1.
    [321] = { SpellID = 321, Cooldown = 1, Duration = 0, Flags = 0, SchoolMask = 0x10, Effects = {
        { ID = 436, SpellID = 321, Effect = 04, TargetType = 02, Flags = 0x01, Period = 0, Points = 2 },
    } },
    ...
    [322] = { SpellID = 322, Cooldown = 2, Duration = 1, Flags = 0, SchoolMask = 0x10, Effects = {
        { ID = 437, SpellID = 322, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.8 },
        { ID = 438, SpellID = 322, Effect = 04, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.8 },
        { ID = 439, SpellID = 322, Effect = 18, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.8 },
    } },
    ...
    [323] = { SpellID = 323, Cooldown = 3, Duration = 2, Flags = 0, SchoolMask = 0x00, Effects = {
        { ID = 440, SpellID = 323, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 0.4 },
        { ID = 441, SpellID = 323, Effect = 12, TargetType = 17, Flags = 0x00, Period = 0, Points = -0.1 },
    } },

    -- Protective Parasol: Heals all adjacent allies for $s1.
    [324] = { SpellID = 324, Cooldown = 1, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 442, SpellID = 324, Effect = 04, TargetType = 08, Flags = 0x01, Period = 0, Points = 1.2 },
    } },
    ...
    [325] = { SpellID = 325, Cooldown = 3, Duration = 2, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 443, SpellID = 325, Effect = 12, TargetType = 08, Flags = 0x00, Period = 0, Points = 0.6 },
    } },
    ...
    [326] = { SpellID = 326, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x10, Effects = {
        { ID = 453, SpellID = 326, Effect = 03, TargetType = 09, Flags = 0x01, Period = 0, Points = 0.25 },
    } },
    ...
    [327] = { SpellID = 327, Cooldown = 5, Duration = 3, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 454, SpellID = 327, Effect = 19, TargetType = 22, Flags = 0x01, Period = 0, Points = 0.2 },
    } },
    ...
    [328] = { SpellID = 328, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x21, Effects = {
        { ID = 455, SpellID = 328, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.3 },
    } },
    ...
    [329] = { SpellID = 329, Cooldown = 5, Duration = 3, Flags = 0, SchoolMask = 0x04, Effects = {
        { ID = 456, SpellID = 329, Effect = 14, TargetType = 01, Flags = 0x00, Period = 0, Points = -0.5 },
    } },
    ...
    [330] = { SpellID = 330, Cooldown = 5, Duration = 2, Flags = 0, SchoolMask = 0x04, Effects = {
        { ID = 457, SpellID = 330, Effect = 19, TargetType = 06, Flags = 0x01, Period = 0, Points = 0.2 },
    } },
    ...
    [331] = { SpellID = 331, Cooldown = 3, Duration = 3, Flags = 0, SchoolMask = 0x04, Effects = {
        { ID = 458, SpellID = 331, Effect = 19, TargetType = 22, Flags = 0x01, Period = 0, Points = 0.2 },
    } },
    ...
    [332] = { SpellID = 332, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 459, SpellID = 332, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 1.5 },
    } },

    -- Overload: Increases damage dealt by $s1 for 3 rounds.
    [333] = { SpellID = 333, Cooldown = 5, Duration = 3, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 460, SpellID = 333, Effect = 19, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.4 },
    } },
    ...
    [334] = { SpellID = 334, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 461, SpellID = 334, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.9 },
    } },
    ...
    [335] = { SpellID = 335, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 462, SpellID = 335, Effect = 03, TargetType = 17, Flags = 0x01, Period = 0, Points = 0.4 },
    } },

    -- Evidence of Wrongdoing: Heal an adjacent ally for $s1.
    [336] = { SpellID = 336, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x04, Effects = {
        { ID = 463, SpellID = 336, Effect = 04, TargetType = 02, Flags = 0x01, Period = 0, Points = 0.8 },
    } },
    ...
    [337] = { SpellID = 337, Cooldown = 4, Duration = 3, Flags = 0, SchoolMask = 0x10, Effects = {
        { ID = 464, SpellID = 337, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 2 },
        { ID = 481, SpellID = 337, Effect = 07, TargetType = 05, Flags = 0x01, Period = 0, Points = 0.4 },
    } },
    ...
    [338] = { SpellID = 338, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 465, SpellID = 338, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [339] = { SpellID = 339, Cooldown = 3, Duration = 0, Flags = 1, SchoolMask = 0x04, Effects = {
        { ID = 466, SpellID = 339, Effect = 03, TargetType = 07, Flags = 0x01, Period = 0, Points = 1.2 },
    } },

    -- Tainted Bite: Deals $s1 Fire damage.
    [340] = { SpellID = 340, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x04, Effects = {
        { ID = 467, SpellID = 340, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 0.6 },
    } },
    ...
    [341] = { SpellID = 341, Cooldown = 5, Duration = 3, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 468, SpellID = 341, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 1.2 },
        { ID = 478, SpellID = 341, Effect = 20, TargetType = 05, Flags = 0x01, Period = 0, Points = 0.2 },
    } },
    ...
    [342] = { SpellID = 342, Cooldown = 1, Duration = 1, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 469, SpellID = 342, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 1 },
        { ID = 477, SpellID = 342, Effect = 19, TargetType = 03, Flags = 0x01, Period = 0, Points = -0.7 },
    } },
    ...
    [343] = { SpellID = 343, Cooldown = 3, Duration = 1, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 470, SpellID = 343, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.8 },
        { ID = 476, SpellID = 343, Effect = 12, TargetType = 01, Flags = 0x00, Period = 0, Points = 0.2 },
    } },
    ...
    [344] = { SpellID = 344, Cooldown = 1, Duration = 0, Flags = 0, SchoolMask = 0x04, Effects = {
        { ID = 471, SpellID = 344, Effect = 03, TargetType = 07, Flags = 0x01, Period = 0, Points = 0.3 },
    } },
    ...
    [345] = { SpellID = 345, Cooldown = 4, Duration = 3, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 472, SpellID = 345, Effect = 20, TargetType = 06, Flags = 0x01, Period = 0, Points = -0.3 },
    } },
    ...
    [346] = { SpellID = 346, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 473, SpellID = 346, Effect = 03, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.3 },
        { ID = 475, SpellID = 346, Effect = 19, TargetType = 03, Flags = 0x01, Period = 0, Points = 0.01 },
    } },
    ...
    [347] = { SpellID = 347, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 474, SpellID = 347, Effect = 03, TargetType = 11, Flags = 0x01, Period = 0, Points = 1 },
    } },

    -- Tainted Bite: Deals $s1 Shadow damage to the furthest enemy and increases their damage taken by $s2 for 3 rounds.
    [348] = { SpellID = 348, Cooldown = 5, Duration = 3, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 479, SpellID = 348, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 1.2 },
        { ID = 480, SpellID = 348, Effect = 20, TargetType = 05, Flags = 0x01, Period = 0, Points = 0.2 },
    } },

    -- Anima Swell: Deals $s1 Arcane damage to all enemies
    [349] = { SpellID = 349, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 482, SpellID = 349, Effect = 03, TargetType = 07, Flags = 0x01, Period = 0, Points = 0.1 },
    } },
    ...
    [350] = { SpellID = 350, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 483, SpellID = 350, Effect = 03, TargetType = 09, Flags = 0x01, Period = 0, Points = 0.25 },
    } },
    ...
    [351] = { SpellID = 351, Cooldown = 4, Duration = 0, Flags = 1, SchoolMask = 0x40, Effects = {
        { ID = 484, SpellID = 351, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 0.75 },
    } },
    ...
    [352] = { SpellID = 352, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 485, SpellID = 352, Effect = 14, TargetType = 01, Flags = 0x01, Period = 2, Points = 0.3 },
    } },
    ...
    [353] = { SpellID = 353, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 486, SpellID = 353, Effect = 12, TargetType = 05, Flags = 0x01, Period = 2, Points = 0.2 },
    } },
    ...
    [354] = { SpellID = 354, Cooldown = 5, Duration = 0, Flags = 1, SchoolMask = 0x40, Effects = {
        { ID = 487, SpellID = 354, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 4 },
    } },
    ...
    [355] = { SpellID = 355, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 488, SpellID = 355, Effect = 12, TargetType = 05, Flags = 0x00, Period = 0, Points = -0.25 },
    } },
    ...
    [356] = { SpellID = 356, Cooldown = 2, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 489, SpellID = 356, Effect = 01, TargetType = 05, Flags = 0x01, Period = 3, Points = 2 },
    } },
    ...
    [357] = { SpellID = 357, Cooldown = 0, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 490, SpellID = 357, Effect = 12, TargetType = 03, Flags = 0x00, Period = 0, Points = -0.5 },
    } },
    ...
    [358] = { SpellID = 358, Cooldown = 5, Duration = 0, Flags = 1, SchoolMask = 0x01, Effects = {
        { ID = 491, SpellID = 358, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 4 },
    } },
    ...
    [359] = { SpellID = 359, Cooldown = 5, Duration = 3, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 492, SpellID = 359, Effect = 07, TargetType = 05, Flags = 0x01, Period = 3, Points = 0.5 },
    } },
    ...
    [360] = { SpellID = 360, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 493, SpellID = 360, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [361] = { SpellID = 361, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 494, SpellID = 361, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.75 },
    } },
    ...
    [362] = { SpellID = 362, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 495, SpellID = 362, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 1.2 },
    } },
    ...
    [363] = { SpellID = 363, Cooldown = 5, Duration = 2, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 496, SpellID = 363, Effect = 12, TargetType = 14, Flags = 0x00, Period = 0, Points = 0.1 },
    } },
    ...
    [364] = { SpellID = 364, Cooldown = 6, Duration = 2, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 497, SpellID = 364, Effect = 09, TargetType = 07, Flags = 0x00, Period = 0, Points = 0 },
    } },
    ...
    [365] = { SpellID = 365, Cooldown = 3, Duration = 1, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 498, SpellID = 365, Effect = 14, TargetType = 03, Flags = 0x00, Period = 0, Points = 0.5 },
    } },
    ...
    [366] = { SpellID = 366, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 499, SpellID = 366, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.5 },
    } },
    ...
    [367] = { SpellID = 367, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 500, SpellID = 367, Effect = 03, TargetType = 11, Flags = 0x01, Period = 0, Points = 0.75 },
    } },
    ...
    [368] = { SpellID = 368, Cooldown = 3, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 501, SpellID = 368, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 0.6 },
    } },
    ...
    [369] = { SpellID = 369, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 502, SpellID = 369, Effect = 07, TargetType = 07, Flags = 0x02, Period = 2, Points = 1 },
    } },
    ...
    [370] = { SpellID = 370, Cooldown = 5, Duration = 2, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 503, SpellID = 370, Effect = 12, TargetType = 07, Flags = 0x00, Period = 2, Points = -0.5 },
    } },
    ...
    [371] = { SpellID = 371, Cooldown = 5, Duration = 2, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 504, SpellID = 371, Effect = 14, TargetType = 22, Flags = 0x00, Period = 0, Points = -0.25 },
    } },
    ...
    [372] = { SpellID = 372, Cooldown = 4, Duration = 0, Flags = 0, SchoolMask = 0x01, Effects = {
        { ID = 505, SpellID = 372, Effect = 03, TargetType = 15, Flags = 0x01, Period = 0, Points = 0.8 },
    } },
    ...
    [373] = { SpellID = 373, Cooldown = 5, Duration = 0, Flags = 0, SchoolMask = 0x40, Effects = {
        { ID = 506, SpellID = 373, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 1 },
        { ID = 507, SpellID = 373, Effect = 04, TargetType = 01, Flags = 0x01, Period = 0, Points = 1 },
    } },

    -- Anima Thirst: Draws anima from the furthest enemy, dealing $s1 Shadow damage and healing itself for $s2.
    [374] = { SpellID = 374, Cooldown = 5, Duration = 0, Flags = 0, SchoolMask = 0x20, Effects = {
        { ID = 508, SpellID = 374, Effect = 03, TargetType = 05, Flags = 0x01, Period = 0, Points = 1 },
        { ID = 509, SpellID = 374, Effect = 04, TargetType = 01, Flags = 0x01, Period = 0, Points = 0.4 },
    } },
    ...
    [375] = { SpellID = 375, Cooldown = 4, Duration = 2, Flags = 0, SchoolMask = 0x08, Effects = {
        { ID = 510, SpellID = 375, Effect = 12, TargetType = 07, Flags = 0x01, Period = 0, Points = -0.2 },
    } },
};